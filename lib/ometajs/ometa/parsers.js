!function(root, factory) {
    ...
    BSOMetaTranslator.jumpTableCode = function(cases) {
        var buf = [];
        buf.push("(function(){switch(this.anything()){");
        for (var i = 0; i < cases.length; ++i) buf.push("case " + cases[i][0] + ":return " + cases[i][1] + ";");
    ...
    var BSAssociativeOptimization = exports.BSAssociativeOptimization = BSNullOptimization._extend({
        ...
        App: function() {
            ...
            return this._or(function() {
                ...
                return BSNullOptimization._superApplyWithArgs(this, "App");
            });
        }
    });
