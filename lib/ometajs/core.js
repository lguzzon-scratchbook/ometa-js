(function (root, factory) {
	...
	*/
	...
	//
	function isSequenceable(o) {
		return typeof o === 'string' || Array.isArray(o) || isObject(o);
	}
	...
	//
	// ### function makeObjectOMInputStream (lst, idx)
	// #### @lst {Array} List
	// #### @idx {Number} index
	// Returns either ObjectOMInputStream's or OMInputStreamEnd's instance
	//
	function makeObjectOMInputStream(lst, idx) {
		return makeListOMInputStream(lst, 0);
	}
